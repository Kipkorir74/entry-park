<div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                <h1 class="page-header">land Survey and Mapping Services</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
							<?php echo form_open( 'index.php/rate/pays/'.$record->plot_no, array( 'id'=>'mvi_form', 'style'=>'' ) ); ?>
						...
						<div class="col-lg-6">
							...
							<div class="panel-heading">
							  ...
							  <div class="panel-body">
								...
								<center>
									<input type="hidden" name="part_id"  value="1" />
