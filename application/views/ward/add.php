<div class="page-content-wrap">
            ...
            <?php if( $this->session->flashdata('error') != "" ) : ?>
                ...
                <?php echo form_open_multipart('ward/add',array('role'=>'form','data-toggle'=>"validator" ,'class'=>"form-horizontal")) ; ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add </strong> Ward</h3>
                                  ...
                                  <div class="col-md-6">  
                                      <div class="row"> 
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-xs-12">                                            
                                                   <input type="text" class="form-control" name="WardName" placeholder=" "  required />
                                    ...
                                    <div class="row"> 
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-xs-12">                                            
                                                   <select  name="SubCountyID" class="form-control select2-list" data-placeholder="" required >
