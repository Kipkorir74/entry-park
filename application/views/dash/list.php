                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-carousel">
                                <div class="owl-carousel" id="owl-example">
                                    <div>                                    
                                        <div class="widget-title">Vehicle Compliancy</div>                                                                        
                                        <div class="widget-subtitle">27/08/2014 15:23</div>
                                        <div class="widget-int">3,548</div>
                                    </div>
                                    <div>                                    
                                        <div class="widget-title">Compliant Vehicles</div>
                                        <div class="widget-subtitle">Vehicles</div>
                                        <div class="widget-int"><?php //echo $info->Compliant?></div>
                                    </div>
                                    <div>                                    
                                        <div class="widget-title">Non Compliant Vehicles</div>
                                        <div class="widget-subtitle">Vehicles</div>
                                        <div class="widget-int"><?php //echo //$info->NonCompliant ?></div>
                                    </div>
                                </div>                            
