  ...
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
                    ...
                    <p style="text-align:center;margin:0;padding:0;">
                        ...
                        <img src="<?php echo base_url(); ?>assets/img/logo.png" width="8%" style="display:inline-block;" />
                    </p>
      ...
      <tr>
                ...
                <p style="text-align:center;margin:0;padding:0;">
                           <!--  <img src="<?php echo base_url('public/annoucnement-01.jpg')?>" style="display:block;" /> -->
                        </p>
                            </td>
                        </tr>
                    </table>
      ...
      <tr>
                <td align="center" valign="top">
                  ...
                  <h3>Hi <?php echo $name;?>,</h3>
                                    <h2><strong>We have a new message for you.</strong></h2>
      ...
      <tr>
                <td align="center" valign="top">
                  ...
                  <a class="blue-btn" href="<?php echo base_url();?>"><strong>Login</strong></a>
                                </td>
                        ...
                        <tr>
                            <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                <p style="text-align:center;">
                                    <img src="<?php echo base_url(); ?>assets/img/logo.png" width="8%" style="margin:0 auto 0 auto;display:inline-block;" />
                                </p>
                                <h6 style="text-align:center;margin-top: 9px;">powered by Crystal</h6>
