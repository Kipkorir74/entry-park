<div class="page-content-wrap">
            ...
            <?php if( $this->session->flashdata('error') != "" ) : ?>
                ...
                <?php echo form_open_multipart('role/add',array('role'=>'form','data-toggle'=>"validator" ,'class'=>"form-horizontal")) ; ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add </strong> System Role</h3>
