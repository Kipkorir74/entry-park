<div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <?php echo form_open( 'report/allperformancesubcounty',array('role'=>'form','data-toggle'=>"validator" ,'class'=>"form-horizontal")) ; ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Performance Report</h3>
