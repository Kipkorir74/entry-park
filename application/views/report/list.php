        ...
        $(function () {
          Highcharts.chart('staff_pie', {
           ...
           colors: [ '#3c8dbc','#FF0000','#EFF217','#B0F217','#CA17F2','#AD9FA5'  ],
            title: {
                text: 'Percentage of Bill Raised'
            },
            subtitle: {
                    text: ''
                },
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title-box">
                                        <h3>Bill Raised from  <?php echo date("d-m-Y", strtotime($date_from)); ?> to  <?php echo date("d-m-Y", strtotime($date_to)); ?></h3>
                         ...
                         <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title-box">
                                         <h3> Percentage of Bill Raised from  <?php echo date("d-m-Y", strtotime($date_from)); ?> to  <?php echo date("d-m-Y", strtotime($date_to)); ?></h3>
                                        <span>Staff  vs Bill Total raised</span>
                                    </div>                                    
                                    <ul class="panel-controls" style="margin-top: 2px;">
                                        <li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    ...
                    <ul class="panel-controls">
                       <a href="<?php echo base_url('report')?>" type="button" class="btn btn-success">Filter Other Date <span class="fa fa-plus"></span></a>
                        ...
                        <thead>
                           <tr>
                            ...
                            <tr>
                                ...
                                <td><a href=" <?php echo base_url('report/details/'.$record->CreatedBy."/". $date_from."/".$date_to )?>"><?php echo ucwords(strtolower($record->FirstName ." ".$record->LastName." ".$record->OtherName));?></a></td>
