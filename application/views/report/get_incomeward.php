            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="display: block;overflow-x: auto; white-space: nowrap;">
                    ...
                    <div class="col-md-4">
                      ...
                      <a class="btn btn-info" href=" <?php echo base_url('report/get_subcountysummary/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>"> Back</a>
                        
                
                    </div>

                   <div class="col-md-6">
                       <h3> <?php echo $subcount.' | '.$stream; ?></h3>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td><?php echo $i + 1; ?></td>
                                 ...
                                 <td><a href="<?php echo base_url('report/detailswardstreamreport/'.$record->IncomeTypeID ."/".$record->WardID )?>"> <?php echo $record->WardName;?></a></td> 
