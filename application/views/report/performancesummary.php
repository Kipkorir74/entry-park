                           ...
                           <tr>
                            ...
                            <?php $total=0; $count=0; for( $i=0; $i<count( $streambillssummarys ); $i++ ) : ?>
                              ...
                              <tr>
                                ...
                                <a href=" <?php echo base_url('report/detailstreamreports/'.$streambillssummary->IncomeTypeID )?>"> <?php echo $streambillssummary->IncomeTypeDescription;?></a>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href=" <?php echo base_url('report/billsraisedreport/'.$userbilled->UserID )?>"> 
                        ...
                        <thead>
                           <tr>
                            ...
                            <tr>
                                ...
                                <a href=" <?php echo base_url('report/printingperincome/'.$printedperincomereceipted->IncomeTypeID )?>"> <?php echo $printedperincomereceipted->IncomeTypeDescription;?></a>
                                  </td> 
                    ...
                    <table class="table datatable1">
                          <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                   <a href=" <?php echo base_url('report/receiptedperreport/'.$receiptedbycashiers->UserID )?>"> 
  ...
  <!--   <div class=" row">
         <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">Bills Raised Via NCCG Self Service Portal </h3>
                    <ul class="panel-controls">
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href=" <?php echo base_url('report/billsraisedsingselfonline/'.$onlinebilled->UserID )?>"> 
