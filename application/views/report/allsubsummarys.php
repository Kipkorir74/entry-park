        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">Sub County Summary Report</h3>
                    <ul class="panel-controls">
                        <?php  if($this->session->userdata('othersubcounty')==1){ ?>
                    <a href="<?php echo base_url('report/selectsummarysubcounty')?>" type="button" class="btn btn-success">  Filter Other Date  <span class="fa fa-search"></span></a>  
                  <?php } ?>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td><?php echo $i + 1; ?></td>
                                 ...
                                 <td><a href="<?php echo base_url('report/wardsummary/'.$record->SubCountyID);?>">  <?php echo $record->SubCountyName;?></a> </td> 
