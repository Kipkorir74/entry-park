                           ...
                           <tr>
                            ...
                            <tr>
                                <td><?php echo $i + 1; ?></td>
                                 ...
                                 <td>  <a href="<?php echo base_url('report/detailswardtreamreports/'.$record->IncomeTypeID ."/".$ward_id.'/'.$this->uri->segment(4) )?>"> <?php echo $record->IncomeTypeDescription;?></a></td> 
